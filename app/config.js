...
config.messenger = {
    oMsgs: {
        ...
        robotPosition: 'Robot\'s position \{{x},{y}\}, facing {f}',
        ...
        welcome: 'Welcome!{eol}Tell the Robot your first command. Begin by placing the Robot on the playground - PLACE X, Y, F {ci}. Numbers[0, 1, 2, 3, 4] \'q\' to exit.',
    },
    oSubs: {
